...
pub static ERROR_CODE_TABLE: &[ErrorCodeDefinition] = &[
    ...
    ErrorCodeDefinition::new(ErrorCode::NX2301, "Await outside async function"),
    ...
    ErrorCodeDefinition::new(ErrorCode::NX2703, "Unknown use path"),
    ...
    ErrorCodeDefinition::new(ErrorCode::NX2740, "Invalid lifecycle/entrypoint location"),
    ...
    ErrorCodeDefinition::new(ErrorCode::NX4001, "Host contract mismatch"),
    ...
    ErrorCodeDefinition::new(ErrorCode::NX7010, "Missing required entrypoint"),
    ErrorCodeDefinition::new(ErrorCode::NX7011, "Entrypoint signature mismatch"),
