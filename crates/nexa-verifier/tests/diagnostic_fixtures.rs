...
const GENERATED_BYTECODE_V5_FIXTURES: [&str; 5] =
...
#[test]
fn generated_diagnostic_fixtures_are_the_exact_bytecode_v5_set() {
    let directory = fixture_directory();
    ...
    assert_eq!(
        generated_names,
        GENERATED_BYTECODE_V5_FIXTURES.into_iter().collect(),
...
#[test]
fn decodable_bytecode_v5_fixtures_round_trip_canonically() {
    ...
    for fixture in generator::encoded_fixtures() {
        ...
        assert_eq!(
            module.encode(),
            fixture.bytes,
            "{} must round-trip through the canonical v5 section encoding",
            fixture.name
        );
