...
fn golden_contract_and_declaration_stable_ids_are_locked() {
    ...
    assert_eq!(
        contract.handles[0].stable_id.0, 0x5805_175c_3d8c_424c,
        "handle Entity"
    );
    ...
    assert_eq!(
        cell.fields[0].stable_id.0, 0x53eb_ec4f_6958_03f3,
        "field Cell.x"
    );
    assert_eq!(
        cell.fields[1].stable_id.0, 0x95c5_b49e_2fa7_3db9,
        "field Cell.y"
    );
    ...
    assert_eq!(
        event.variants[0].stable_id.0, 0xad45_75c2_a09e_68ca,
        "variant Started"
    );
    assert_eq!(
        event.variants[1].stable_id.0, 0xb1b3_8d20_96ad_b205,
        "variant Ended"
    );
    ...
    assert_eq!(
        log.parameters[0].stable_id.0, 0x46d1_c221_b976_5897,
        "host fn log(message)"
    );

    let on_event = &contract.nexa_functions[0];
    assert_eq!(
        on_event.stable_id.0, 0xced5_39c2_2107_132d,
        "nexa fn on_event"
    );
    assert_eq!(
        on_event.parameters[0].stable_id.0, 0x3e42_b2a3_0f2a_4476,
...
fn golden_generated_public_binding_api_snapshot_is_locked() {
    let contract = parse_contract(GOLDEN_SOURCE).expect("Golden source parses");
    let rust =
        generate_rust_for_source_file(&contract, "golden.contract.nexa").expect("codegen succeeds");
...
const GOLDEN_DESCRIPTOR_BYTES: &[u8] = &[
    ,
];

const GOLDEN_FINGERPRINT: [u8; 32] = [
    0x35, 0xc9, 0xe9, 0xe3, 0x88, 0xd3, 0x06, 0x8e, 0xc2, 0xed, 0xcf, 0x60, 0x7f, 0xf5, 0x4e, 0xc4,
    0xa6, 0x41, 0x49, 0xa6, 0xa2, 0x64, 0x47, 0xf5, 0xd0, 0x2c, 0xce, 0x87, 0x9d, 0x78, 0xa4, 0x6a,
];
