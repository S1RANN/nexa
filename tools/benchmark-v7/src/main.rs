...
struct ProfilerGcSummary {
    ...
    work_objects: u64,
    work_bytes: u64,
    object_budget_overrun: u64,
    byte_budget_overrun: u64,
    duration_budget_overrun_ns: u64,
    max_pause_time_ns: u64,
    incremental_work_time_ns: u64,
    live_bytes: u64,
...
fn profiler_summary(enabled: bool) -> Option<ProfilerSummary> {
    ...
    Some(ProfilerSummary {
        ...
        gc: ProfilerGcSummary {
            ...
            last_cycle: gc.last_cycle,
            last_phase: match gc.last_phase {
                nexa_runtime::GcPhase::Idle => "idle",
                nexa_runtime::GcPhase::RootSnapshot => "root-snapshot",
                nexa_runtime::GcPhase::Mark => "mark",
                nexa_runtime::GcPhase::Sweep => "sweep",
                nexa_runtime::GcPhase::Complete => "complete",
            },
            roots_scanned: gc.roots_scanned,
            roots_seeded: gc.roots_seeded,
            objects_marked: gc.objects_marked,
            bytes_marked: gc.bytes_marked,
            slots_swept: gc.slots_swept,
            objects_reclaimed: gc.objects_reclaimed,
            bytes_reclaimed: gc.bytes_reclaimed,
            barrier_writes: gc.barrier_writes,
            barrier_shades: gc.barrier_shades,
            work_objects: gc.work_objects,
            work_bytes: gc.work_bytes,
            object_budget_overrun: gc.object_budget_overrun,
            byte_budget_overrun: gc.byte_budget_overrun,
            duration_budget_overrun_ns: gc.duration_budget_overrun_ns,
            max_pause_time_ns: gc.max_pause_time_ns,
            incremental_work_time_ns: gc.incremental_work_time_ns,
            live_bytes: gc.live_bytes,
            fragmentation_per_mille: gc.fragmentation_per_mille,
        },
        tasks: ProfilerTaskSummary {
            polls: tasks.polls,
