...
use nexa_gate1_v2_8::{AnyError, read_json, stable_value_hash, write_json};

const FIXTURE_ROOT: &str = "experiments/gate1-v2.8/fixtures/v2_5_h2";
const COMPARISON_FIXTURE_ROOT: &str = "experiments/gate1-v2.8/fixtures/v2_5_comparisons";
const CHECK_ROOT: &str = "target/gate1-v2.8-dryrun";
...
pub fn h2_semantic_projection(result: &Value) -> Result<Value, AnyError> {
    ...
    let projection = json!({
        "schema_version": 1,
        "projection": "gate1-v2.8-h2-semantic-v1",
...
pub fn h2_performance_projection(result: &Value) -> Result<Value, AnyError> {
    ...
    Ok(json!({
        "schema_version": 1,
        "projection": "gate1-v2.8-h2-performance-v1",
        "warmup_samples": 100,
        "timed_samples": 1000,
...
pub fn h2_allocation_projection(result: &Value) -> Result<Value, AnyError> {
    ...
    Ok(json!({
        "schema_version": 1,
        "projection": "gate1-v2.8-h2-allocation-v1",
...
fn compare_performance(left: &Value, right: &Value) -> Result<Value, AnyError> {
    let policy = read_json("experiments/gate1-v2.8/h2_performance_policy.json")?;
